...
**0.**  Take a look at the existing [issues](https://github.com/MahmoudMADIH) or create your own issues. Wait for the Issue to be assigned to you after which you can start working on it.

**1.**  Fork [this](https://github.com/MahmoudMADIH) repository.
...
```
git remote add upstream https://github.com/MahmoudMADIH
```
